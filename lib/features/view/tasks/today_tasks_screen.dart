                        ...
                        itemBuilder: (context, index) {
                          ...
                          return TaskCard(
                            ...
                            onTap: () async {
                                ...
                                MaterialPageRoute(
                                  builder: (_) => BlocProvider(
                                    create: (context) => EditTaskCubit(
                                      EditTaskRepo(Provider.of<AuthRepoImp>(context, listen: false)),
                                    ),
                                    child: EditTaskScreen(
                                      taskData: task.toJson(),
                                      onDelete: () {
                                        context.read<TodayTasksCubit>().deleteTask(task.id);
                                        // Refresh home screen
                                        try {
                                          context.read<HomeCubit>().refreshTasks();
                                        } catch (e) {
                                          // HomeCubit might not be available
                                        }
                                      },
                                    ),
                                  ),
                              ...
                              // Refresh both screens after editing
                              cubit.loadTasks();
                              try {
                                context.read<HomeCubit>().refreshTasks();
                              } catch (e) {
